...
const AIAssistant = () => {
  ...
  const getAIResponse = (userInput) => {
    ...
    if (lower.includes("risk")) {
      response =
        "To manage risk, diversify your portfolio. Balance volatile assets with established ones like BTC and ETH.";
    } else if (lower.includes("profit") || lower.includes("gains")) {
      response =
        "A common strategy is partial profit-taking. Lock gains and reinvest to reduce exposure.";
    } else if (
      lower.includes("buy") ||
      lower.includes("sell") ||
      ...
      response =
        "I can't give financial advice. Always DYOR and consider risk tolerance before trading.";
    } else if (lower.includes("hello") || lower.includes("hi")) {
      response = "Hi! How can I help you today?";
    } else {
      response =
        "I'm still learning. I currently help with general risk and profit strategies.";
    }
