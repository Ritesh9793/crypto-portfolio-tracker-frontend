    ...
    <DashboardLayout>
      <div className="app-page text-white">
        <div className="page-header">
          <div>
            <span className="page-kicker">Trade journal</span>
            <h2 className="page-title">Manage and review trade activity</h2>
            <p className="page-subtitle">
              Add, edit, and remove trades while keeping quantity validation and
              buy-versus-sell visibility in one place.
            </p>
          </div>
